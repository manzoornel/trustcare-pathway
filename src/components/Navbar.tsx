        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {auth.isAuthenticated ? (
              ...
              <Link
                to="/login"
                className="flex items-center gap-1 text-primary hover:text-primary/80 font-semibold transition-colors duration-200 font-display"
              >
                <LogIn size={18} />
                Patient Login
              </Link>
        ...
        <div className="md:hidden animate-fade-in">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white">
            ...
            {auth.isAuthenticated ? (
              ...
              <Link
                to="/login"
                className="flex items-center gap-1 px-3 py-2 text-base font-medium text-primary font-display"
                onClick={() => setIsOpen(false)}
              >
                <LogIn size={18} />
                Patient Login
